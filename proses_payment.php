...
if (!isset($_GET['id_tagihan']) || !isset($_GET['nis'])) {
    die("Parameter tidak lengkap!");
}

$id_tagihan = mysqli_real_escape_string($conn, $_GET['id_tagihan']);
...
if ($show_payment && $jumlah_bayar > 0) {
    ...
    try {
        ...
        // Simpan log transaksi awal ke database lokal
...
<body>
    <div class="payment-card">
        ...
        <form method="POST" action="proses_payment.php?id_tagihan=<?= urlencode($id_tagihan) ?>&nis=<?= urlencode($nis) ?>" id="formBayar">
